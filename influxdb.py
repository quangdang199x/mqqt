...
print(conection)
client_2 = InfluxDBClient('localhost', 8086, 'admin', 'Password1', 'mydb')
client_2.create_database('myDatabases')
client_2.get_list_database()
client_2.switch_database('myDatabases')
